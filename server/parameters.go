...
//   - FleetID - the ID of the Amazon GameLift Servers fleet containing your Anywhere compute.
//   - AuthToken - the authorization token generated by the Amazon GameLift Servers operation.
//   - AwsRegion - the AWS Region of the Game Server.
//   - AccessKey - the AWS AccessKey of the AWS Credentials with Amazon GameLift Servers Access.
//   - SecretKey - the AWS SecretKey of the AWS Credentials with Amazon GameLift Servers Access.
//   - SessionToken - the AWS Token of the AWS Credentials with Amazon GameLift Servers Access if using temporary credentials.
...
//     that the Amazon GameLift Servers service invokes to communicate with the server process.
...
type ProcessParameters struct {
	// OnStartGameSession - callback function that the Amazon GameLift Servers service invokes to activate a new game session.
	...
	// OnUpdateGameSession - callback function that the Amazon GameLift Servers service invokes to pass
	// an updated game session object to the server process.
	// Amazon GameLift Servers calls this function when a match backfill request has been processed
	...
	// OnProcessTerminate - callback function that the Amazon GameLift Servers service invokes to force
	// the server process to shut down.
	// After calling this function, Amazon GameLift Servers waits five minutes for the server process to shut down
	// and respond with a ProcessEnding() call.
	// If no response is received, it shuts down the server process.
	OnProcessTerminate func()

	// OnHealthCheck - callback function that the Amazon GameLift Servers service invokes to request a health status report
	// from the server process.
	// Amazon GameLift Servers calls this function every 60 seconds.
	// After calling this function Amazon GameLift Servers waits 60 seconds for a response,
...
// that you want Amazon GameLift Servers to upload and store once the game session ends.
