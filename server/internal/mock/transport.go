...
import (
	transport "github.com/amazon-gamelift/amazon-gamelift-servers-go-server-sdk/server/internal/transport"
	url "net/url"
	reflect "reflect"
...
// PreventAutoReconnect mocks base method.
func (m *MockITransport) PreventAutoReconnect() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "PreventAutoReconnect")
}

// PreventAutoReconnect indicates an expected call of PreventAutoReconnect.
func (mr *MockITransportMockRecorder) PreventAutoReconnect() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PreventAutoReconnect", reflect.TypeOf((*MockITransport)(nil).PreventAutoReconnect))
}
